...
function getFXRate(ccy1, ccy2){
    var xmlhttp = new XMLHttpRequest();
    var result;
    var url = "http://query.yahooapis.com/v1/public/yql?q=select * from yahoo.finance.xchange where pair in ('"+ccy1+ccy2+"')&env=store://datatables.org/alltableswithkeys";
    console.log(url);

    xmlhttp.open("GET",url,false);

    xmlhttp.send();
    result = xmlhttp.responseXML.getElementsByTagName("Rate");
